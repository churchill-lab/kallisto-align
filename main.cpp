...
#define PROGNAME "[kallisto-align]"
...
int main(int argc, char *argv[]) {
    try {
        ...
        cxxopts::Options options(argv[0], " - pseudo-align to kallisto-align format");
        options.add_options()
                ("help", "Print help")
                ...
                ("b,bin", "kallisto-align output file", cxxopts::value<std::string>());
